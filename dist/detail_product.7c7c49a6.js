 ...
 *  Licensed under MIT
 *
 */ /*JS Lint helpers: */ /*global dragMove: false, dragEnd: false, $, jQuery, alert, window, document */ /*jslint nomen: true, continue:true */ if (typeof Object.create !== "function") Object.create = function(obj) {
    function F() {}
    F.prototype = obj;
    return new F();
};
    ...
    var Carousel = {
        ...
        loadContent: function() {
            ...
            function getData(data) {
                var i, content = "";
                if (typeof base.options.jsonSuccess === "function") base.options.jsonSuccess.apply(this, [
                    data
                ]);
                else {
            ...
            if (typeof base.options.beforeInit === "function") base.options.beforeInit.apply(this, [
                base.$elem
            ]);
        ...
        onStartup: function() {
            ...
            base.eachMoveUpdate();
            if (typeof base.options.afterInit === "function") base.options.afterInit.apply(this, [
                base.$elem
            ]);
        },
        eachMoveUpdate: function() {
            ...
            base.onVisibleItems();
            if (typeof base.options.afterAction === "function") base.options.afterAction.apply(this, [
                base.$elem
            ]);
        },
        updateVars: function() {
            var base = this;
            if (typeof base.options.beforeUpdate === "function") base.options.beforeUpdate.apply(this, [
                base.$elem
            ]);
            ...
            base.updateControls();
            base.eachMoveUpdate();
            if (typeof base.options.afterUpdate === "function") base.options.afterUpdate.apply(this, [
                base.$elem
            ]);
        },
        reload: function() {
        ...
        watchVisibility: function() {
            ...
            if (base.$elem.is(":visible") === false) {
                ...
                window1.clearInterval(base.autoPlayInterval);
                window1.clearInterval(base.checkVisible);
            } else return false;
            base.checkVisible = window1.setInterval(function() {
        ...
        response: function() {
            ...
            lastWindowWidth = $(window1).width();
            base.resizer = function() {
                if ($(window1).width() !== lastWindowWidth) {
                    if (base.options.autoPlay !== false) window1.clearInterval(base.autoPlayInterval);
                    window1.clearTimeout(smallDelay);
                    smallDelay = window1.setTimeout(function() {
                        lastWindowWidth = $(window1).width();
                        base.updateVars();
                    }, base.options.responsiveRefreshRate);
                }
            };
            $(window1).resize(base.resizer);
        },
        ...
        goTo: function(position, speed, drag) {
            ...
            if (base.isTransition) return false;
            if (typeof base.options.beforeMove === "function") base.options.beforeMove.apply(this, [
                base.$elem
            ]);
        ...
        afterGo: function() {
            ...
            if (typeof base.options.afterMove === "function" && base.prevItem !== base.currentItem) base.options.afterMove.apply(this, [
                base.$elem
            ]);
        },
        stop: function() {
        ...
        play: function() {
            ...
            window1.clearInterval(base.autoPlayInterval);
            base.autoPlayInterval = window1.setInterval(function() {
                base.next(true);
        ...
        checkBrowser: function() {
            var base = this, translate3D = "translate3d(0px, 0px, 0px)", tempElem = document1.createElement("div"), regex, asSupport, support3d, isTouch;
            tempElem.style.cssText = "  -moz-transform:" + translate3D + "; -ms-transform:" + translate3D + "; -o-transform:" + translate3D + "; -webkit-transform:" + translate3D + "; transform:" + translate3D;
            regex = /translate3d\(0px, 0px, 0px\)/g;
            asSupport = tempElem.style.cssText.match(regex);
            support3d = asSupport !== null && asSupport.length === 1;
            isTouch = "ontouchstart" in window1 || window1.navigator.msMaxTouchPoints;
            base.browser = {
                "support3d": support3d,
                "isTouch": isTouch
            };
        ...
        eventTypes: function() {
            ...
            base.ev_types = {};
            if (base.options.mouseDrag === true && base.options.touchDrag === true) types = [
                "touchstart.owl mousedown.owl",
                "touchmove.owl mousemove.owl",
                "touchend.owl touchcancel.owl mouseup.owl"
            ];
            else if (base.options.mouseDrag === false && base.options.touchDrag === true) types = [
                "touchstart.owl",
                "touchmove.owl",
                "touchend.owl touchcancel.owl"
            ];
            else if (base.options.mouseDrag === true && base.options.touchDrag === false) types = [
                "mousedown.owl",
                "mousemove.owl",
                "mouseup.owl"
            ];
        ...
        gestures: function() {
            /*jslint unparam: true*/ var base = this, locals = {
                offsetX: 0,
                offsetY: 0,
                baseElWidth: 0,
                relativePos: 0,
            ...
            function swapEvents(type) {
                if (type === "on") {
                    $(document1).on(base.ev_types.move, dragMove);
                    $(document1).on(base.ev_types.end, dragEnd);
                } else if (type === "off") {
                    $(document1).off(base.ev_types.move);
                    $(document1).off(base.ev_types.end);
                }
            }
            function dragStart(event) {
                var ev = event.originalEvent || event || window1.event, position;
            ...
            function dragMove(event) {
                var ev = event.originalEvent || event || window1.event, minSwipe, maxSwipe;
                ...
                if ((base.newPosY > 10 || base.newPosY < -10) && locals.sliding === false) $(document1).off("touchmove.owl");
                minSwipe = function() {
            ...
            function dragEnd(event) {
                var ev = event.originalEvent || event || window1.event, newPosition, handlers, owlStopEvent;
        ...
        customEvents: function() {
            /*jslint unparam: true*/ var base = this;
        ...
        lazyPreload: function($item, $lazyImg) {
            ...
            function showImage() {
                ...
                if (typeof base.options.afterLazyLoad === "function") base.options.afterLazyLoad.apply(this, [
                    base.$elem
                ]);
            }
            function checkLazyImage() {
                ...
                else if (iterations <= 100) window1.setTimeout(checkLazyImage, 100);
                else showImage();
            }
            checkLazyImage();
        },
        autoHeight: function() {
            ...
            function addHeight() {
                ...
                if (!base.wrapperOuter.hasClass("autoHeight")) window1.setTimeout(function() {
            ...
            function checkImage() {
                ...
                else if (iterations <= 100) window1.setTimeout(checkImage, 100);
                else base.wrapperOuter.css("height", ""); //Else remove height attribute
            }
        ...
        clearEvents: function() {
            ...
            $(document1).off(".owl owl");
            $(window1).off("resize", base.resizer);
        },
        unWrap: function() {
            var base = this;
...
//# sourceMappingURL=detail_product.7c7c49a6.js.map
