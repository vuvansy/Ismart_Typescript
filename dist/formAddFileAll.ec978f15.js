...
})({"eaVbu":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "8aeac350ec978f15";
"use strict";
...
},{}],"lErJl":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("ec0f73c590c45349"));
const ProductService_1 = __importDefault(require("bdf3c7159e12ebef"));
$(document).ready(()=>{
    $("#profile_pic_form_multiple").submit((event)=>{
        ...
        if (multipleImagesInput instanceof HTMLInputElement && multipleImagesInput.files !== null) {
            ...
            try {
                ...
                productService.insertFormAll(formData).then((data)=>{
                    ...
                    } else console.log("Upload image failed");
                }).catch((error)=>{
...
},{"ec0f73c590c45349":"6L6hL","bdf3c7159e12ebef":"63Op7"}],"63Op7":[function(require,module,exports) {
"use strict";
...
},{"4c07ce9b16b5c7cd":"jo6P5"}]},["eaVbu","lErJl"], "lErJl", "parcelRequiref2d3")

//# sourceMappingURL=formAddFileAll.ec978f15.js.map
