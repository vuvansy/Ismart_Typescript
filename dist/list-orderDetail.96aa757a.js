...
})({"6bUcI":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "bd4d795a96aa757a";
"use strict";
...
},{}],"iBI8Y":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("70948e189fbb410d"));
const CartService_1 = __importDefault(require("b6608c8a7ed60e75"));
const OrderDetailService_1 = __importDefault(require("3015d4059fcb9ef6"));
$(document).ready(function() {
    ...
    try {
        ...
        cartService.findCartByIdOrder(idOrder).then((data)=>{
            ...
            console.log(orderId);
            orderDetailService.findOderDetailByIdOrder(orderId).then((orderDetails)=>{
                ...
                for (const orderDetail of orderDetails){
                    ...
                    list += `
                            <tr>
                                ...
                                <td>${name}</td>
                                <td>${price_new}\u{111}</td>
                                <td><span
                                class="badge badge-success"
                                >${od_quantity}</span
                            ></td>
                                <td>${od_total}\u{111}</td>
                            </tr>
                        `;
                }
                list += `
                    <tr>
                        ...
                        >
                            Th\xf4ng tin \u{111}\u{1A1}n h\xe0ng v\u{1EAD}n chuy\u{1EC3}n
                        </td>
                    </tr>
                    `;
                list += `
               ...
               <td colspan="5">
                        <div class="left">
                            <div class="id_order">
                            M\xe3 \u{111}\u{1A1}n h\xe0ng: <strong>${data._id}</strong>
                            </div>
                            <div class="user_order">
                            T\xean ng\u{1B0}\u{1EDD}i \u{111}\u{1EB7}t h\xe0ng: <strong>${data.fullname}</strong>
                            </div>
                            <div class="phone_order">
                            S\u{1ED1} \u{111}i\u{1EC7}n tho\u{1EA1}i ng\u{1B0}\u{1EDD}i \u{111}\u{1EB7}t h\xe0ng: <strong>${data.phone}</strong>
                            </div>
                        </div>
                        <div class="right">
                            ...
                            \u{110}\u{1ECB}a ch\u{1EC9} \u{111}\u{1EB7}t h\xe0ng: <strong>${data.address}</strong>
                            </div>
                            <div class="content">
                            Ghi ch\xfa: <strong>${data.note}</strong>
                            </div>
                            <div class="data_order">
                            Th\u{1EDD}i gian \u{111}\u{1EB7}t h\xe0ng: <strong>${convertDateFormat(data.createdAt)}</strong>
                            </div>
                         </div>
                </td>
                </tr>
...
},{"70948e189fbb410d":"6L6hL","b6608c8a7ed60e75":"7qzCS","3015d4059fcb9ef6":"cQ5Ze"}],"7qzCS":[function(require,module,exports) {
"use strict";
...
const axios_1 = __importDefault(require("4afe1daebf78ccab"));
class CartService {
    constructor(endPoint){
        ...
        this.findCartByIdUser = (userId)=>__awaiter(this, void 0, void 0, function*() {
                try {
                    const response = yield axios_1.default.get(this.endPoint + this.collectionName + "/user" + "/" + userId);
        ...
        this.findCartByStatus = (status)=>__awaiter(this, void 0, void 0, function*() {
                try {
                    const response = yield axios_1.default.get(this.endPoint + this.collectionName + "/status/" + status);
                    if (response.status === 200) return response.data;
                    else return null;
                } catch (error) {
                    return error;
        ...
        this.findCartByIdOrder = (idOrder)=>__awaiter(this, void 0, void 0, function*() {
                try {
                    const response = yield axios_1.default.get(this.endPoint + this.collectionName + "/" + idOrder);
                    if (response.status === 200) return response.data;
                    else return null;
                } catch (error) {
                    return error;
        ...
        this.updateOrderStatus = (orderId, newStatus)=>__awaiter(this, void 0, void 0, function*() {
                try {
                    const response = yield axios_1.default.patch(`${this.endPoint}${this.collectionName}/${orderId}`, {
                        status: newStatus
                    });
                    return response.data;
                } catch (error) {
                    console.error(error);
                    throw new Error("C\u1EADp nh\u1EADt tr\u1EA1ng th\xe1i \u0111\u01A1n h\xe0ng th\u1EA5t b\u1EA1i");
                }
            });
...
},{"4afe1daebf78ccab":"jo6P5"}],"cQ5Ze":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
const axios_1 = __importDefault(require("ad7476c17c4e45b"));
...
},{"ad7476c17c4e45b":"jo6P5"}]},["6bUcI","iBI8Y"], "iBI8Y", "parcelRequiref2d3")

//# sourceMappingURL=list-orderDetail.96aa757a.js.map
