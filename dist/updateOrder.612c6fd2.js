...
})({"b7DDi":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f7b6e7c9612c6fd2";
"use strict";
...
},{}],"b8fPs":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("ce59b2f14daa6a7b"));
const CartService_1 = __importDefault(require("86ac3057b23881a5"));
$(document).ready(function() {
    ...
    cartService.findCartByIdOrder(id).then((data)=>{
        ...
        if (statusCtrl.val() === "1" || statusCtrl.val() === "2") $("#cancel_order").hide();
        // Kiểm tra nếu đơn hàng đã hoàn thành
        if (statusCtrl.val() === "2") // Ẩn các tùy chọn trạng thái khác
        $("#statusOrder option").each(function() {
            if ($(this).val() !== "2") $(this).hide();
        });
        // Kiểm tra nếu đơn hàng đã bị hủy
        if (statusCtrl.val() === "3") // Ẩn các tùy chọn trạng thái khác
        $("#statusOrder option").each(function() {
            if ($(this).val() !== "3") $(this).hide();
        });
    });
    $("#update_order").on("click", (e)=>{
        const confirmed = confirm("B\u1EA1n c\xf3 ch\u1EAFc ch\u1EAFn mu\u1ED1n c\u1EADp nh\u1EADt cho \u0111\u01A1n h\xe0ng");
        if (confirmed) {
            ...
            if (newStatus !== undefined) {
                ...
                try {
                    cartService.updateOrderStatus(id, newStatus.toString()).then((data)=>{
...
},{"ce59b2f14daa6a7b":"6L6hL","86ac3057b23881a5":"7qzCS"}],"7qzCS":[function(require,module,exports) {
"use strict";
...
},{"4afe1daebf78ccab":"jo6P5"}]},["b7DDi","b8fPs"], "b8fPs", "parcelRequiref2d3")

//# sourceMappingURL=updateOrder.612c6fd2.js.map
