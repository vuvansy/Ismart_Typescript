...
})({"iZXYa":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "0c9986ba689518d3";
"use strict";
...
},{}],"divPA":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("dc0967dc68834a35"));
const ProductService_1 = __importDefault(require("d3aae0441352f2b5"));
$(document).ready(()=>{
    $("#profile_pic_form").submit((event)=>{
        event.preventDefault(); // Ngăn chặn form submit mặc định
        const imageInput = document.getElementById("profile_pic");
        if (imageInput instanceof HTMLInputElement && imageInput.files !== null) {
            ...
            try {
                ...
                productService.insertForm(formData).then((data)=>{
                    if (data.status === 1) {
...
},{"dc0967dc68834a35":"6L6hL","d3aae0441352f2b5":"63Op7"}],"63Op7":[function(require,module,exports) {
"use strict";
...
},{"4c07ce9b16b5c7cd":"jo6P5"}]},["iZXYa","divPA"], "divPA", "parcelRequiref2d3")

//# sourceMappingURL=formAddFile.689518d3.js.map
