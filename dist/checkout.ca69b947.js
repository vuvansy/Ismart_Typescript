...
const JsonServerConstants_1 = __importDefault(require("e7dd199153d01400"));
const CartService_1 = __importDefault(require("3ce1444c1768a43e"));
const OrderDetailService_1 = __importDefault(require("401989d60d442a7"));
$(document).ready(function() {
    ...
    $("#order_now").on("click", ()=>{
        ...
        if (!gh || gh.length === 0) {
            alert("Gi\u1ECF h\xe0ng c\u1EE7a b\u1EA1n hi\u1EC7n \u0111ang tr\u1ED1ng. Vui l\xf2ng th\xeam s\u1EA3n ph\u1EA9m v\xe0o gi\u1ECF h\xe0ng tr\u01B0\u1EDBc khi thanh to\xe1n.");
            return;
        }
        if (infoUser && infoUser.id) {
            ...
            if (!paymentMethod) {
                alert("Vui l\xf2ng ch\u1ECDn ph\u01B0\u01A1ng th\u1EE9c thanh to\xe1n!");
                return;
            }
            const order = {
                userId: userId,
            ...
            try {
                ...
                cartService.insertCart(order).then((order)=>{
                    ...
                    orderDetailService.insertOrderDetail(orderDetails).then(()=>{
                        alert("\u0110\u1EB7t h\xe0ng th\xe0nh c\xf4ng!");
            ...
            alert("Vui l\xf2ng \u0111\u0103ng nh\u1EADp tr\u01B0\u1EDBc khi \u0111\u1EB7t h\xe0ng!");
            location.href = "login.html";
        }
    });
});

},{"e7dd199153d01400":"6L6hL","3ce1444c1768a43e":"7qzCS","401989d60d442a7":"cQ5Ze"}],"7qzCS":[function(require,module,exports) {
"use strict";
...
},{"ad7476c17c4e45b":"jo6P5"}]},["hfgpI","bLoNB"], "bLoNB", "parcelRequiref2d3")
