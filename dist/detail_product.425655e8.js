$(document).ready(function() {
    ...
    $(window).scroll(function() {
        if ($(this).scrollTop() != 0) $("#btn-top").stop().fadeIn(150);
        else $("#btn-top").stop().fadeOut(150);
    });
    ...
    $("html").on("click", function(event) {
        ...
        if (target.is("#btn-respon i")) {
            if (!site.hasClass("show-respon-menu")) site.addClass("show-respon-menu");
            else site.removeClass("show-respon-menu");
        } else $("#container").click(function() {
...
//# sourceMappingURL=detail_product.425655e8.js.map
