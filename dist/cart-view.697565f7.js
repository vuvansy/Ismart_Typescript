...
})({"jgkex":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "7ce3d9a6697565f7";
"use strict";
...
},{}],"gyPdV":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("2db402c2a48302ed"));
const CartService_1 = __importDefault(require("91f2e1ddb4e60641"));
$(document).ready(function() {
    ...
    if (infoUser && infoUser.id) {
        ...
        try {
            ...
            cartService.findCartByIdUser(id).then((data)=>{
                ...
                for(const key in data){
                    ...
                    if (paymentMethod === "0") paymentMethodText = "Thanh to\xe1n b\u1EB1ng th\u1EBB t\xedn d\u1EE5ng";
                    else if (paymentMethod === "1") paymentMethodText = "Thanh to\xe1n khi nh\u1EADn h\xe0ng";
                    const statusText = statusMap[status]; // Ánh xạ giá trị trạng thái từ số sang chuỗi
                    let actionButton = "";
                    if (status === "0") actionButton = `<button class="cancel-order-button" data-order-id="${_id}">H\u{1EE7}y</button>`;
                    else actionButton = `<button class="view-order-button" data-order-id="${_id}">Chi ti\u{1EBF}t</button>`;
                    list += `
            <tr>
              <td>${_id}</td>
              <td>${quantity}</td>
          ...
          `;
                ...
                $(".cancel-order-button").on("click", function() {
                    ...
                    console.log(orderId);
                    const confirmed = confirm("B\u1EA1n c\xf3 ch\u1EAFc ch\u1EAFn mu\u1ED1n h\u1EE7y \u0111\u01A1n h\xe0ng n\xe0y?");
                    if (confirmed) {
                        const newStatus = "3"; // Trạng thái mới
                        try {
                            cartService.updateOrderStatus(orderId, newStatus).then((data)=>{
        ...
        const placeholder = $("#showCartView");
        placeholder.append("<p>B\u1EA1n c\u1EA7n \u0111\u0103ng nh\u1EADp \u0111\u1EC3 xem danh s\xe1ch \u0111\u01A1n h\xe0ng.</p>");
    }
});

},{"2db402c2a48302ed":"6L6hL","91f2e1ddb4e60641":"7qzCS"}],"7qzCS":[function(require,module,exports) {
"use strict";
...
},{"4afe1daebf78ccab":"jo6P5"}]},["jgkex","gyPdV"], "gyPdV", "parcelRequiref2d3")

//# sourceMappingURL=cart-view.697565f7.js.map
