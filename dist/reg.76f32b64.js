...
})({"gewZC":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3d7dad8976f32b64";
"use strict";
...
},{}],"59Fpn":[function(require,module,exports) {
"use strict";
...
const JsonServerConstants_1 = __importDefault(require("4c167a6852a61acf"));
const UserService_1 = __importDefault(require("13bdb02181235529"));
$(document).ready(function() {
    ...
    formReg.addEventListener("submit", function(e) {
        ...
        if (username === "" || password === "" || fullname === "" || email === "" || phone === "" || address === "" || confirm_pass === "") {
            alert("Vui l\xf2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 th\xf4ng tin");
            return;
        }
        // Kiểm tra mật khẩu và xác nhận mật khẩu khớp nhau
        if (password !== confirm_pass) {
            alert("M\u1EADt kh\u1EA9u v\xe0 x\xe1c nh\u1EADn m\u1EADt kh\u1EA9u kh\xf4ng kh\u1EDBp");
            return;
        }
...
},{"4c167a6852a61acf":"6L6hL","13bdb02181235529":"04sFJ"}],"04sFJ":[function(require,module,exports) {
"use strict";
...
const axios_1 = __importDefault(require("f8bc885a315046c1"));
class UserService {
    constructor(endPoint){
        ...
        this.findUserByUsernameAndPassword = (username, password)=>__awaiter(this, void 0, void 0, function*() {
                try {
                    const response = yield axios_1.default.post(`${this.endPoint}${this.collectionName}/login`, {
                        username,
                        password
...
},{"f8bc885a315046c1":"jo6P5"}]},["gewZC","59Fpn"], "59Fpn", "parcelRequiref2d3")

//# sourceMappingURL=reg.76f32b64.js.map
