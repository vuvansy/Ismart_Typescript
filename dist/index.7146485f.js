...
})({"6SbCd":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "60ba5e547146485f";
"use strict";
...
},{}],"hvMvw":[function(require,module,exports) {
...
$(document).ready(function() {
    const categoryService = new (0, _categoryServiceDefault.default)((0, _jsonServerConstantsDefault.default).EndPoint);
    try {
        ...
        categoryService.findAllCategories().then((data)=>{
            ...
            for(const key in data){
                ...
                list += `
                <li>
                <a href="category_product.html?id=${id}" title="">${name}</a>
                </li>
            `;
            }
...
class CategoryService {
    ...
    insertCategory = async (category)=>{
        try {
            const response = await (0, _axiosDefault.default).post(this.endPoint + this.collectionName, category);
            return response.data;
        } catch (error) {
            return error;
        }
    ...
    updateCategory = async (id, updateCategory)=>{
        try {
            const response = await (0, _axiosDefault.default).put(this.endPoint + this.collectionName + "/" + id, updateCategory);
            return response.data;
        } catch (error) {
            return error;
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6SbCd","hvMvw"], "hvMvw", "parcelRequiref2d3")

//# sourceMappingURL=index.7146485f.js.map
